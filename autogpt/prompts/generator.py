...
class PromptGenerator:
    ...
    def __init__(self) -> None:
        ...
        """
        self.constraints = [
            "MANAGEMENT CONSTRAINT: Do not use weeks/hrs/days as your main time units but rather thinking steps." 
            "HIRING CONSTRAINT: You cannot hire other humans but only other AI agents like yourself with youre hire_staff command"
        ...
        self.commands = []
        self.resources = [
            "YOUR STAFF: A list of your staff members, their roles, current spending, and their current engagement.",
        ...
        self.performance_evaluation = [
            "WORK CONTINUATION: Try to continue working while waiting on responses of your employees."
            "EMPLOYEES ARE AI AGENTS: Your employees will have the same constraints and resources as you since they are also AI Agents."
            "DONT MICROMANAGE: Give your employees time to respond and do not send them too many consecutive messages.",
